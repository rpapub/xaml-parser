...
from xaml_parser import OutputValidator, ValidationError, validate_output
...
class TestOutputValidation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valid_variable = WorkflowVariable(name="test_var", type="x:String", scope="workflow")
