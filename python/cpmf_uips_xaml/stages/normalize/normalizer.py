...
from ...stages.analysis.anti_patterns import AntiPatternDetector
...
from ...shared.model.models import Activity, ParseResult, WorkflowArgument, WorkflowVariable
from .ordering import sort_by_id, sort_by_name
from .provenance import create_provenance
from ...stages.analysis.quality_metrics import QualityMetricsCalculator
...
class Normalizer:
    ...
    def __init__(
        ...
        if flow_extractor is None:
            from ...stages.assemble.control_flow import ControlFlowExtractor
            flow_extractor = ControlFlowExtractor(self.id_generator)
    ...
    def normalize(
        ...
        metadata = WorkflowMetadata(
            ...
            annotation_block=parse_annotation(content.root_annotation),
    ...
    def _transform_activity(self, activity: Activity) -> ActivityDto:
        ...
        return ActivityDto(
            ...
            annotation_block=activity.annotation_block,
    ...
    def _transform_argument(self, argument: WorkflowArgument) -> ArgumentDto:
        ...
        return ArgumentDto(
            ...
            annotation_block=argument.annotation_block,
